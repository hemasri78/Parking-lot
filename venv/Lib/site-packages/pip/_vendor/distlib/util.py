...
class PyPIRCFile(object):
    ...
    DEFAULT_service = 'https://upload.pypi.org/legacy/'
    DEFAULT_REALM = 'pypi'
    ...
    def read(self):
        ...
        if os.path.exists(self.filename):
            service = self.url or self.DEFAULT_service
            ...
            if 'distutils' in sections:
                ...
                if _servers == []:
                    ...
                    for server in _servers:
                        ...
                        # work around people having "service" for the "pypi"
                        # section of their config set to the HTTP (rather than
                        # HTTPS) URL
                        if (server == 'pypi' and service
                                in (self.DEFAULT_service, 'pypi')):
                            result['service'] = self.DEFAULT_service
                        elif (result['server'] != service
                ...
                if config.has_option(server, 'service'):
                    service = config.get(server, 'service')
                else:
